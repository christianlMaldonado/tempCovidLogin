...
class NameForm extends React.Component {
  ...
  handleChange = (e) => {
    this.setState({ name: e.target.text, email: e.target.email, number: e.target.number }
    )
  }

  handleSubmit = (e) => {
    alert('Text was just submitted: ' + this.state.email + this.state.email + this.state.number)
    e.preventDefault()
  }
    ...
    return(
      <div>
        ...
        <form className='formField' onSubmit={this.handleSubmit}>
          ...
          <p>
              2. Are you experiencing any of these <b><u> NEW </u></b> symptoms <b> <u> NOT </u></b>
          ...
          <select> 
            ...
            <p>
                If you checked the box for any of the listed symptoms, complete the employee signature 
                section below and contact your supervisor immediately for further direction. <b> If you
                are not experiencing any of the symptoms above, complete the employee signature
                section below, proceed to your worksite and provide this signed form to your supervisor/manager
                upon arrival</b>
            </p> 

            By signing below, I certify that my response above are accurate to the best of my knowledge.
            ...
            <label>  Department/Worksite Location :  
            <input type="text" text={this.state.text} onChange={this.handleChange} />
            </label>
